...
with open(Path(__file__).parent/'classChar.json', 'r',encoding='utf8',errors='ignore') as f:
...
def hello():
    ...
    # tensor is stored in imgObj
    # class confidence score --belongs to prediction
